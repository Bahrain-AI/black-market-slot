...
export const DEMO_ROUNDS: RoundBook[] = [{
  ...
  events: [
    ...
    { index: 1, type: 'win', positions: [{ reel: 0, row: 0 }, { reel: 1, row: 0 }, { reel: 2, row: 0 }], amount: 2 },
    ...
    { index: 10, type: 'win', positions: [{ reel: 2, row: 0 }, { reel: 2, row: 1 }, { reel: 2, row: 2 }, { reel: 2, row: 3 }], amount: 5 },
    ...
    { index: 15, type: 'holdSpinStart', respins: 3, locked: [{ reel: 0, row: 0, value: 2 }] },
    { index: 16, type: 'holdSpinRespins', remaining: 2 },
    { index: 17, type: 'holdSpinLock', resetRespins: 3, locks: [{ reel: 3, row: 2, value: 5, multiplier: 2 }] },
    { index: 18, type: 'holdSpinRespins', remaining: 2 },
    { index: 19, type: 'holdSpinEnd', total: 10 },
    { index: 20, type: 'payout', amount: 12, total: 12 },
    { index: 21, type: 'roundEnd', payoutMultiplier: 12 }
  ]
}];
